            ...
            <div className="max-w-xl w-full space-y-10 bg-white/95 backdrop-blur-xl p-12 rounded-3xl shadow-2xl border border-white/50 z-10">
                ...
                {error && (
                    <div className="bg-red-50 border-l-4 border-red-500 text-red-700 p-4 rounded-lg text-base font-medium">
                        ...
                        {error === 'User already exists' && (
                            <div className="mt-2">
                                <Link to="/login" className="underline font-bold hover:text-red-900">
                                    Login instead?
                                </Link>
                            </div>
                        )}
                ...
                <div className="text-center mt-6">
                    <p className="text-base text-gray-600">
                        Already have an account? <Link to="/login" className="font-bold text-indigo-600 hover:text-indigo-500 hover:underline transition-colors">Sign in</Link>
                    </p>
                </div>
            </div>
        </div>
